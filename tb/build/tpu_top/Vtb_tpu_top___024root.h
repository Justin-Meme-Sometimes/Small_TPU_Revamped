...
class alignas(VL_CACHE_LINE_BYTES) Vtb_tpu_top___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*7:0*/ tb_tpu_top__DOT__dut__DOT__dma__DOT__weight_we_in_single;
        CData/*7:0*/ tb_tpu_top__DOT__dut__DOT__dma__DOT__bias_we_in_single;
        CData/*7:0*/ tb_tpu_top__DOT__dut__DOT__dma__DOT__act_we_in_single;
        ...
        CData/*0:0*/ __Vtask_tb_tpu_top__DOT__check__124__cond;
        CData/*0:0*/ __Vtask_tb_tpu_top__DOT__check__126__cond;
        CData/*0:0*/ __Vtask_tb_tpu_top__DOT__check__129__cond;
        CData/*0:0*/ __Vtask_tb_tpu_top__DOT__check__131__cond;
        CData/*0:0*/ __Vtask_tb_tpu_top__DOT__check__133__cond;
    };
    struct {
        CData/*0:0*/ __Vtask_tb_tpu_top__DOT__check__136__cond;
        CData/*0:0*/ __Vtask_tb_tpu_top__DOT__check__138__cond;
        CData/*0:0*/ __Vtask_tb_tpu_top__DOT__check__140__cond;
        CData/*4:0*/ __Vtask_tb_tpu_top__DOT__wait_for_state__157__target;
        ...
        IData/*31:0*/ __Vtask_tb_tpu_top__DOT__run_group_test__118__trial_num;
        IData/*31:0*/ __Vtask_tb_tpu_top__DOT__run_group_test__118__num_trials;
        IData/*31:0*/ __Vtask_tb_tpu_top__DOT__wait_for_state__157__max_cycles;
        IData/*31:0*/ __Vtask_tb_tpu_top__DOT__wait_for_state__157__cycles_taken;
        IData/*31:0*/ __VactIterCount;
    };
    std::string __Vtask_tb_tpu_top__DOT__check__122__name;
    std::string __Vtask_tb_tpu_top__DOT__check__124__name;
    std::string __Vtask_tb_tpu_top__DOT__check__126__name;
    std::string __Vtask_tb_tpu_top__DOT__check__129__name;
    std::string __Vtask_tb_tpu_top__DOT__check__131__name;
    std::string __Vtask_tb_tpu_top__DOT__check__133__name;
    std::string __Vtask_tb_tpu_top__DOT__check__136__name;
    std::string __Vtask_tb_tpu_top__DOT__check__138__name;
    std::string __Vtask_tb_tpu_top__DOT__check__140__name;
