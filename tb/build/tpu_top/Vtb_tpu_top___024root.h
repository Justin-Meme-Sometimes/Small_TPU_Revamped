...
class alignas(VL_CACHE_LINE_BYTES) Vtb_tpu_top___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ tb_tpu_top__DOT__dut__DOT__load_dma_en;
        CData/*0:0*/ tb_tpu_top__DOT__dut__DOT__load_dma_clr;
        ...
        CData/*0:0*/ tb_tpu_top__DOT__dut__DOT__dma__DOT__banks_clr;
        ...
        CData/*5:0*/ tb_tpu_top__DOT__dut__DOT__dma__DOT__dma_fsm__DOT__current_state;
        CData/*5:0*/ tb_tpu_top__DOT__dut__DOT__dma__DOT__dma_fsm__DOT__next_state;
        ...
        SData/*8:0*/ tb_tpu_top__DOT__dut__DOT__load_dma_count;
