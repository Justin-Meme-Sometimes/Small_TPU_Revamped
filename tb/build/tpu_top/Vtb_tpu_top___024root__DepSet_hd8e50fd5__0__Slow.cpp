...
VL_ATTR_COLD void Vtb_tpu_top___024root___stl_sequent__TOP__0(Vtb_tpu_top___024root* vlSelf) {
    ...
    tb_tpu_top__DOT__dut__DOT____VdfgExtracted_h621a341a__0 
        = ((3U == (IData)(vlSelf->tb_tpu_top__DOT__dut__DOT__funcs_count)) 
           & (8U == (IData)(vlSelf->tb_tpu_top__DOT__dut__DOT__tile_count)));
    vlSelf->tb_tpu_top__DOT__dut__DOT__dma__DOT__any_busy 
        = ((IData)(vlSelf->tb_tpu_top__DOT__dut__DOT__dma__DOT__activations_busy) 
           | ((IData)(vlSelf->tb_tpu_top__DOT__dut__DOT__dma__DOT__bias_busy) 
              | (IData)(vlSelf->tb_tpu_top__DOT__dut__DOT__dma__DOT__weights_busy)));
...
VL_ATTR_COLD void Vtb_tpu_top___024root___ctor_var_reset(Vtb_tpu_top___024root* vlSelf) {
    ...
    vlSelf->tb_tpu_top__DOT__dut__DOT__dma__DOT__activations_busy = VL_RAND_RESET_I(1);
    vlSelf->tb_tpu_top__DOT__dut__DOT__dma__DOT__weights_busy = VL_RAND_RESET_I(1);
    vlSelf->tb_tpu_top__DOT__dut__DOT__dma__DOT__bias_busy = VL_RAND_RESET_I(1);
    vlSelf->tb_tpu_top__DOT__dut__DOT__dma__DOT__any_busy = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_tpu_top__DOT__dut__DOT__dma__DOT__b_fsm__DOT__any_busy = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_tpu_top__DOT__dut__DOT__dma__DOT__a_fsm__DOT__any_busy = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vtask_tb_tpu_top__DOT__run_group_test__106__trial_num = 0;
    vlSelf->__Vtask_tb_tpu_top__DOT__run_group_test__106__num_trials = 0;
    vlSelf->__Vtask_tb_tpu_top__DOT__check__110__cond = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_tb_tpu_top__DOT__check__112__cond = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_tb_tpu_top__DOT__check__115__cond = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_tb_tpu_top__DOT__check__117__cond = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_tb_tpu_top__DOT__check__120__cond = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_tb_tpu_top__DOT__check__122__cond = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_tb_tpu_top__DOT__check__135__cond = VL_RAND_RESET_I(1);
