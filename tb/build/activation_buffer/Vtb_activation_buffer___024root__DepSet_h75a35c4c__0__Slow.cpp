...
#endif
            VL_FATAL_MT("tb/tb_activation_buffer.sv", 25, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_activation_buffer___024root___ctor_var_reset(Vtb_activation_buffer___024root* vlSelf) {
    ...
    VL_RAND_RESET_W(2048, vlSelf->tb_activation_buffer__DOT__ib_dut__DOT__buff);
    vlSelf->tb_activation_buffer__DOT__ib_dut__DOT__curr_count = VL_RAND_RESET_I(8);
    vlSelf->tb_activation_buffer__DOT__bf_dut__DOT__current_state = VL_RAND_RESET_I(5);
    vlSelf->tb_activation_buffer__DOT__bf_dut__DOT__next_state = VL_RAND_RESET_I(5);
    ...
    vlSelf->tb_activation_buffer__DOT__act_dut__DOT__A__DOT__current_state = VL_RAND_RESET_I(5);
    vlSelf->tb_activation_buffer__DOT__act_dut__DOT__A__DOT__next_state = VL_RAND_RESET_I(5);
    vlSelf->tb_activation_buffer__DOT__act_dut__DOT__B__DOT__current_state = VL_RAND_RESET_I(5);
    vlSelf->tb_activation_buffer__DOT__act_dut__DOT__B__DOT__next_state = VL_RAND_RESET_I(5);
    VL_RAND_RESET_W(2048, vlSelf->tb_activation_buffer__DOT__act_dut__DOT__BUFF_A__DOT__buff);
    vlSelf->tb_activation_buffer__DOT__act_dut__DOT__BUFF_A__DOT__curr_count = VL_RAND_RESET_I(8);
    VL_RAND_RESET_W(2048, vlSelf->tb_activation_buffer__DOT__act_dut__DOT__BUFF_B__DOT__buff);
    vlSelf->tb_activation_buffer__DOT__act_dut__DOT__BUFF_B__DOT__curr_count = VL_RAND_RESET_I(8);
