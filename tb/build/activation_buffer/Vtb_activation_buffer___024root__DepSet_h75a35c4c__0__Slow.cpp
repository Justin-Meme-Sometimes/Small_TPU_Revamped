...
VL_ATTR_COLD void Vtb_activation_buffer___024root___ctor_var_reset(Vtb_activation_buffer___024root* vlSelf) {
    ...
    vlSelf->tb_activation_buffer__DOT____Vcellout__ib_dut__re_out = VL_RAND_RESET_I(32);
    ...
    vlSelf->tb_activation_buffer__DOT____Vcellout__act_dut__output_buff = VL_RAND_RESET_I(32);
    ...
    vlSelf->tb_activation_buffer__DOT__act_dut__DOT__write_in_a = VL_RAND_RESET_I(32);
    vlSelf->tb_activation_buffer__DOT__act_dut__DOT__re_out_a = VL_RAND_RESET_I(32);
    ...
    vlSelf->tb_activation_buffer__DOT__act_dut__DOT__write_in_b = VL_RAND_RESET_I(32);
    vlSelf->tb_activation_buffer__DOT__act_dut__DOT__re_out_b = VL_RAND_RESET_I(32);
