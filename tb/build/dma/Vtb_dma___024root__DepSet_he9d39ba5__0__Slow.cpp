...
VL_ATTR_COLD void Vtb_dma___024root___ctor_var_reset(Vtb_dma___024root* vlSelf) {
    ...
    vlSelf->tb_dma__DOT__in_prefill = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__prefill_start = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__tile_done = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__group_done = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_dma__DOT__activation_bank_out = VL_RAND_RESET_I(32);
    vlSelf->tb_dma__DOT__activation_bank_out_valid = VL_RAND_RESET_I(1);
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->tb_dma__DOT__act_captured[__Vi0] = 0;
    }
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
    ...
    vlSelf->tb_dma__DOT__dut__DOT__weight_we_in_single = VL_RAND_RESET_I(8);
    vlSelf->tb_dma__DOT__dut__DOT__bias_we_in_single = VL_RAND_RESET_I(8);
    vlSelf->tb_dma__DOT__dut__DOT__act_we_in_single = VL_RAND_RESET_I(8);
    vlSelf->tb_dma__DOT__dut__DOT__en_counter = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__clr_counter = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__a_ready = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__b_ready = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__w_ready = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__act_we_en_counter = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__act_we_clr_counter = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__act_we_count = VL_RAND_RESET_I(9);
    ...
    vlSelf->tb_dma__DOT__dut__DOT__act_re = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__act_full = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__act_empty = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__act_en_counter = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__act_clr_counter = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__act_re_count = VL_RAND_RESET_I(9);
    ...
    vlSelf->tb_dma__DOT__dut__DOT__act_read_fsm__DOT__current_state = VL_RAND_RESET_I(6);
    vlSelf->tb_dma__DOT__dut__DOT__act_read_fsm__DOT__next_state = VL_RAND_RESET_I(6);
    VL_RAND_RESET_W(1024, vlSelf->tb_dma__DOT__dut__DOT__act_buf__DOT__buff);
    vlSelf->tb_dma__DOT__dut__DOT__act_buf__DOT__wr_ptr = VL_RAND_RESET_I(10);
    vlSelf->tb_dma__DOT__dut__DOT__act_buf__DOT__rd_ptr = VL_RAND_RESET_I(10);
