...
#endif
            VL_FATAL_MT("tb/tb_dma.sv", 20, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_dma___024root___ctor_var_reset(Vtb_dma___024root* vlSelf) {
    ...
    vlSelf->tb_dma__DOT__prefill_state = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_dma__DOT__dut__DOT__tile_done = VL_RAND_RESET_I(1);
    vlSelf->tb_dma__DOT__dut__DOT__bank = VL_RAND_RESET_I(4);
    ...
    vlSelf->tb_dma__DOT__dut__DOT__banks_clr = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_dma__DOT__dut__DOT__dma_fsm__DOT__current_state = VL_RAND_RESET_I(6);
    vlSelf->tb_dma__DOT__dut__DOT__dma_fsm__DOT__next_state = VL_RAND_RESET_I(6);
