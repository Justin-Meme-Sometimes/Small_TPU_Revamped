...
class alignas(VL_CACHE_LINE_BYTES) Vtb_dma___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ tb_dma__DOT__in_prefill;
        CData/*0:0*/ tb_dma__DOT__prefill_start;
        CData/*0:0*/ tb_dma__DOT__tile_done;
        CData/*0:0*/ tb_dma__DOT__group_done;
        ...
        IData/*31:0*/ tb_dma__DOT__activation_bank_out;
        ...
        CData/*0:0*/ tb_dma__DOT__dut__DOT__act_we_en_counter;
        CData/*0:0*/ tb_dma__DOT__dut__DOT__act_we_clr_counter;
        ...
        CData/*0:0*/ tb_dma__DOT__dut__DOT__act_en_counter;
        CData/*0:0*/ tb_dma__DOT__dut__DOT__act_clr_counter;
        ...
        CData/*5:0*/ tb_dma__DOT__dut__DOT__act_read_fsm__DOT__current_state;
        CData/*5:0*/ tb_dma__DOT__dut__DOT__act_read_fsm__DOT__next_state;
        VlWide<32>/*1023:0*/ tb_dma__DOT__dut__DOT__act_buf__DOT__buff;
    ...
    struct {
        ...
        SData/*8:0*/ tb_dma__DOT__dut__DOT__act_we_count;
        SData/*8:0*/ tb_dma__DOT__dut__DOT__act_re_count;
        ...
        VlUnpacked<CData/*7:0*/, 16> tb_dma__DOT__act_captured;
