...
class alignas(VL_CACHE_LINE_BYTES) Vtb_dma___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ tb_dma__DOT__prefill_state;
    ...
    CData/*0:0*/ tb_dma__DOT__dut__DOT__tile_done;
    CData/*3:0*/ tb_dma__DOT__dut__DOT__bank;
    CData/*0:0*/ tb_dma__DOT__dut__DOT__weight_we;
    CData/*0:0*/ tb_dma__DOT__dut__DOT__weight_re;
    IData/*31:0*/ tb_dma__DOT__dut__DOT__weight_we_in;
    ...
    IData/*31:0*/ tb_dma__DOT__dut__DOT__act_we_in;
    ...
    CData/*5:0*/ tb_dma__DOT__dut__DOT__dma_fsm__DOT__current_state;
    CData/*5:0*/ tb_dma__DOT__dut__DOT__dma_fsm__DOT__next_state;
