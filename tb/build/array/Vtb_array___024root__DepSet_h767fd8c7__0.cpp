...
void Vtb_array___024root___eval_triggers__act(Vtb_array___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_array___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, (((IData)(vlSelf->tb_array__DOT__clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_array__DOT__clk__0))) 
                                     | ((~ (IData)(vlSelf->tb_array__DOT__h_rst_n)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_array__DOT__h_rst_n__0))));
    vlSelf->__VactTriggered.set(1U, (((IData)(vlSelf->tb_array__DOT__clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_array__DOT__clk__0))) 
                                     | ((~ (IData)(vlSelf->tb_array__DOT__v_rst_n)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_array__DOT__v_rst_n__0))));
    vlSelf->__VactTriggered.set(2U, (((~ (IData)(vlSelf->tb_array__DOT__arr_rst_n)) 
                                      & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_array__DOT__arr_rst_n__0)) 
                                     | ((IData)(vlSelf->tb_array__DOT__clk) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_array__DOT__clk__0)))));
    vlSelf->__VactTriggered.set(3U, ((IData)(vlSelf->tb_array__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_array__DOT__clk__0))));
