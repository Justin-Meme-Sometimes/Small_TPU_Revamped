...
declare -A TESTS=(
  ...
  [dma]="src/DMA.sv"
  [tpu_top]="src/tpu_top.sv src/DMA.sv src/weight_fifo.sv src/activation_buffer.sv src/array.sv src/pe.sv src/relu_buffer.sv src/requant.sv src/bias_add.sv"
)
